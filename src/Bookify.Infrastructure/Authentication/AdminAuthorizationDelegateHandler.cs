...
public sealed class AdminAuthorizationDelegateHandler : DelegatingHandler
{
    private readonly KeycloakOptions _keycloakOptions;

    public AdminAuthorizationDelegateHandler(IOptions<KeycloakOptions> keycloakOptions)
    {
